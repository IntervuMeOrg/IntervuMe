	...
	return (
		...
		>
			<div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
				<TemplateIcon className="h-4 w-4 sm:h-5 sm:w-5 text-[#e8eef2] flex-shrink-0" />
				<h3 className="font-['Nunito'] font-bold text-white text-base sm:text-lg md:text-xl">
					Select Interview Template
				</h3>
			</div>

			<p className="text-[#e8eef2] text-xs sm:text-sm opacity-80 mb-4 sm:mb-6">
			...
			<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 mb-6 sm:mb-8">
				{templates.map((templateCategory, categoryIndex) => (
					...
					>
						<h4
							id="template-header"
							className="font-['Nunito'] font-bold text-white text-sm sm:text-base mb-1 sm:mb-2"
						>
									...
									>
										<div className="flex-1">
											<h5
												...
												className="font-['Nunito'] font-bold text-white text-sm sm:text-base"
											>
												{template}
											</h5>
											<p className="text-[#e8eef2] text-xs sm:text-sm opacity-80 mt-1 leading-relaxed">
										...
										{isSelected && (
											<CheckIcon className="h-5 w-5 sm:h-6 sm:w-6 text-[#0667D0] ml-2 flex-shrink-0" />
										)}
									</motion.div>
								);
							})}
			...
			{selectedTemplate && (
				<motion.div
					initial={{ opacity: 0 }}
					animate={{ opacity: 1 }}
					className="mt-4 sm:mt-6 border-t border-white/20 pt-4 sm:pt-6"
				>
					<h4 className="font-['Nunito'] font-bold text-white text-base sm:text-lg mb-3 sm:mb-4">
						Template Preview
					</h4>
					<div className="bg-white/10 p-3 sm:p-4 rounded-lg border border-white/20">
						<h5 className="font-['Nunito'] font-bold text-white text-sm sm:text-base mb-2">
			...
			{selectedTemplate && (
				<motion.div
					initial={{ opacity: 0, y: 10 }}
					animate={{ opacity: 1, y: 0 }}
					className="mt-4 sm:mt-6 p-3 sm:p-4 bg-[#0667D0]/10 border border-[#0667D0]/30 rounded-lg"
				>
