...
export const ProfileStatsCards = ({ interviewStats }: ProfileStatsCardsProps) => {
  const stats = [
    ...
    {
      icon: <TrendingUpIcon className="h-4 w-4 sm:h-5 sm:w-5 text-[#e8eef2] flex-shrink-0" />,
    ...
    {
      icon: <AwardIcon className="h-4 w-4 sm:h-5 sm:w-5 text-[#e8eef2] flex-shrink-0" />,
      title: "Top Skill",
    ...
    {
      icon: <AlertTriangleIcon className="h-4 w-4 sm:h-5 sm:w-5 text-[#e8eef2] flex-shrink-0" />,
      title: "Focus Area",
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-5">
      {stats.map((stat, index) => (
        <motion.div
          ...
          className="bg-[#1d1d20] rounded-lg p-4 sm:p-5 shadow-lg relative overflow-hidden group h-full"
          whileHover={{ 
            y: -5, 
        ...
        >
          ...
          <div className="relative z-10 h-full flex flex-col">
            ...
            <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
              {stat.icon}
              <h3 className="font-['Nunito'] font-bold text-[#e8eef2] text-sm sm:text-base leading-tight">
                {stat.title}
              </h3>
            </div>
            
            {/* Value */}
            <p className="font-['Nunito'] text-[#e8eef2] text-lg sm:text-xl md:text-2xl font-bold mb-2 flex-grow flex items-center">
              {stat.value}
            </p>
