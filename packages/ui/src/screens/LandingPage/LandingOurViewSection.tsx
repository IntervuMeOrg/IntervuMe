...
export const OurViewSection = ({ navigate }: OurViewSectionProps) => {
  return (
    <motion.section
      ...
      className="relative py-16 sm:py-20 md:py-24 lg:py-16 bg-[#1d1d20] w-full overflow-hidden"
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.h2
            ...
            className="font-['Nunito'] font-black text-2xl sm:text-3xl md:text-4xl text-[#e8eef2] mb-6 sm:mb-8 break-words"
          >
            Our View
          </motion.h2>
          ...
          <motion.p
            ...
            className="font-['Nunito'] text-sm sm:text-base md:text-lg text-[#e8eef2] leading-relaxed mb-8 sm:mb-10 md:mb-12 break-words px-2 sm:px-0"
          >
          ...
          >
            <Button
              ...
              className="w-full sm:w-auto px-6 sm:px-12 py-2.5 sm:py-3 h-auto
