...
export const UpdateCodingQuestionRequestBody = Type.Partial(
  Type.Object({
    ...CreateCodingQuestionRequestBody.properties,
    testCases: Type.Array(UpdateTestCaseRequestBody, { minItems: 1 }),
  })
);
